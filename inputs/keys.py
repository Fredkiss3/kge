...
class KeyCode(Input, abstract=True):
    """
...
class NumpadOne(KeyCode):
    """
    NumPad 1
    """


class NumpadTwo(KeyCode):
    """
    NumPad 2
    """


class NumpadThree(KeyCode):
    """
    NumPad 3
    """


class NumpadFour(KeyCode):
    """
    NumPad 4
    """


class NumpadFive(KeyCode):
    """
    NumPad 5
    """


class NumpadSix(KeyCode):
    """
    NumPad 6
    """


class NumpadSeven(KeyCode):
    """
    NumPad 7
    """


class NumpadEight(KeyCode):
    """
    NumPad 8
    """


class NumpadNine(KeyCode):
    """
    NumPad 9
    """


class NumpadZero(KeyCode):
    """
    NumPad 0
    """
...
class NumpadPlus(KeyCode):
    """
    Numpad +
    """


class NumpadDivide(KeyCode):
    """
    Numpad /
    """


class NumpadEquals(KeyCode):
    """
    Numpad =
    """


class NumpadMinus(KeyCode):
    """
    Numpad -
    """


class NumpadMultiply(KeyCode):
    """
    Numpad *
    """


class NumpadEnter(KeyCode):
    """
    Numpad Enter
    """


class NumpadDot(KeyCode):
    """
    Numpad .
    """
