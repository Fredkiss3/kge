  ...
  V(FIRST_HEAP_OBJECT_TYPE, 0) \
    ...
    V(FIRST_JS_RECEIVER_TYPE, 186) \
      ...
      V(FIRST_JS_OBJECT_TYPE, 189) \
        ...
        V(WASM_GLOBAL_OBJECT_TYPE, 1111) \
        V(WASM_INSTANCE_OBJECT_TYPE, 1112) \
        V(WASM_MEMORY_OBJECT_TYPE, 1113) \
        V(WASM_MODULE_OBJECT_TYPE, 1114) \
        V(WASM_TABLE_OBJECT_TYPE, 1115) \
        V(WASM_TAG_OBJECT_TYPE, 1116) \
